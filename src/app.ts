...
export class App {
    ...
    constructor({
        ...
        const categoryCont = categoryController || new CategoryController(categoryServ);
        const categoryRouter = new CategoryRouter(categoryCont);


        const catalogRepo = catalogRepository || new MongoCatalogRepository();
        const catalogServ = catalogService || new CatalogService(catalogRepo, productRepo);
    ...
    static getDefaults() {
        ...
        const catalogService = new CatalogService(catalogRepository, productRepository);
