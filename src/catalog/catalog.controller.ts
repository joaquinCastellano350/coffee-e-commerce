...
export class CatalogController {
    ...
    async getCatalogProducts(req: FilteredRequest, res: Response, next: NextFunction) {
        try {
            ...
            const products = await this.catalogService.getCatalogProducts(slug, req.filters);
    ...
    async updateCatalog(req: Request, res: Response, next: NextFunction) {
        try {
            const updatedCatalog = await this.catalogService.updateCatalog(req.params.id, req.body);
    ...
    async disableCatalog(req: Request, res: Response, next: NextFunction) {
        try {
            const disabledCatalog = await this.catalogService.disableCatalog(req.params.id);
    ...
    async enableCatalog(req: Request, res: Response, next: NextFunction) {
        try {
            const enabledCatalog = await this.catalogService.enableCatalog(req.params.id);
